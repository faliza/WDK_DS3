...
def resource_parse(resource_matrix, file_name):
    ...
    for line in input_file:
        # print(f"-----------------------line : {line}")
        # print(f"found_new_resource: {found_new_resource}")
        ...
        if not(found_new_resource):
            ...
            if (current_line[0] == 'add_new_resource'):                         # The key word "add_new_resource" implies that the config file defines a new resource
                # print("add_new_resource detected")
                ...
                for i in range(capacity):
                    ...
                    # print("The type of the new resource: ", current_line[2])
                    new_resource.name = current_line[4]+'_'+str(i + last_PE_ID)
                    # print("The name of the new resource: ", new_resource.name)
                    ...
                    # print("Number of functionalities supported by this resource: ",new_resource.num_of_functionalities)
        ...
        # end of: if not(found_new_resource)
            ...
            #-----------------Throughput-------------        
            # elif current_line[0] == 'throughput':
            #     for ii in range(capacity):
            #         length = len(resource_matrix.list)
            #         ind_PE = length - 1 - ii
            #         resource_matrix.list[ind_PE].throughput = float(current_line[1]) 
            #         # print(f"Throughput {ind_PE} : {float(current_line[1])} ")
            # #-----------------Throughput-------------
            #-----------------power-------------        
            elif current_line[0] == 'power':
                for ii in range(capacity):
                    length = len(resource_matrix.list)
                    ind_PE = length - 1 - ii
                    resource_matrix.list[ind_PE].power = float(current_line[1]) 
                    # print(f"Throughput {ind_PE} : {float(current_line[1])} ")
