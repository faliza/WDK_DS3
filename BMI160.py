...
for w in range(0, num_windows):
    ...
    if (random_num <= 0.3):
        sample_off = int(0.29*window_length)
    elif (random_num > 0.3 and random_num <= 0.5):
        sample_off = int(0.43*window_length)
    elif (random_num > 0.5 and random_num <= 0.8):
        sample_off = int(0.57*window_length)
